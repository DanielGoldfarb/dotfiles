...
hi Normal	guifg=lightgrey guibg=lightblue	ctermfg=lightgray ctermbg=black
...
hi IncSearch	guifg=darkgreen guibg=black	gui=reverse,underline	ctermfg=darkgreen ctermbg=black cterm=reverse,underline
...
hi LineNr	guifg=blue	ctermfg=blue cterm=none
